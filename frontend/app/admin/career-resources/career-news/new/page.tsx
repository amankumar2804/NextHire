...
export default function CreateCareerNewsPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/career-news`, {
        method: "POST",
      ...
      try {
        ...
        throw new Error("Create article API returned an invalid response");
      }
      ...
      console.error("Create Career News Error:", error);
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="mt-3 text-indigo-100">
                Publish career news and updates.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="Example: Meta ordered to pay $567 million..."
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Example: AFP, Reuters"
                  className="w-full rounded-xl border border-slate-300 px-4 py-3.5 outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Small summary shown on the news card..."
